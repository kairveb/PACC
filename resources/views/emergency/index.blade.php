...
<div class="space-y-6">
    ...
    <div class="panel-card p-6">
        ...
        <form method="GET" action="{{ route('emergency.checkin.lookup') }}" class="mb-6 flex flex-col gap-3 rounded-2xl border border-sky-200 bg-sky-50 p-4 md:flex-row md:items-end">
            <div class="flex-1">
